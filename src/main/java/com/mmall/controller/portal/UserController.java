...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<String> forgetRestPasssword(String username, String passwordNew, String forgetToken) {
        return iUserService.forgetRestPasssword(username, passwordNew, forgetToken);
    }
