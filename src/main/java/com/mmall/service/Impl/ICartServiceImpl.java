            ...
            for (Cart cartItem : cartList) {
                ...
                if (product != null) {
                    ...
                    if (product.getStock() >= cartItem.getQuantity()) {
                        ...
                        //购物车中更新有效库存
                        Cart cartByQuantity = new Cart();
                        cartByQuantity.setId(cartItem.getId());
                        cartByQuantity.setQuantity(buyLimitCount);
                        cartMapper.updateByPrimaryKeySelective(cartByQuantity);
                    }
